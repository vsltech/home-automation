...
<div class="portfolio" id="portfolio">
  <div class="container">
	...
	<font face="calibri">
		...
		<table>
			<tr><td><h2 class="text-center">Plant Monitoring- Soil Sensor</h2>
			    Monitoring your garden in real-time</td>
			</tr>
		</table>
			...
			<tr>
				<td>
					<?php 
						...
						if($status[0]==0)
							echo '<img src="images/sad-plant.jpg" width=200px>';
							
						
						if($status[0]==1)
							echo '<img src="images/happy-plant.jpg" width=200px>';
						
				   
					?>
				</td>
				<td><h4 class="text-center">Status:<?php	if($status[0]==0)	echo 'Pour Water!';
															if($status[0]==1)	echo 'No Water Required';
													?></h4><br>
