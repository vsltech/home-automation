...
<div class="portfolio" id="portfolio">
  <div class="container">
	...
	<font face="calibri">
		...
		<table>
			<tr><td><h2 class="text-center">Gas Leak Monitoring- Gas Sensor</h2>
											<div align="center">Monitoring your safety in real-time</div>
				</td>
			</tr>
		</table>
			...
			<tr>
				<td>
					<?php 
						...
						if($status[0]==0)
							echo '<img src="images/safety.png" width=200px>';
							
						
						if($status[0]==1)
							echo '<img src="images/fire-extinguisher.gif" width=200px>';
						
				   
					?>
				</td>
				<td align="center"><h4 class="text-center">Status:<?php	if($status[0]==0)	echo 'You are safe!';
															if($status[0]==1)	echo 'Move Out! Danger!';
													?></h4><br>
